...
def plot(args):
    ...
    fig.update_layout(
        ...
        height=600,
        title_x=0.5,
        title_text="Breakdown of Latency (s)<br>3 Concurrent Queries for 3 Different 3B model; 1x RTX 3090; 2.1 GB/s",
    )
    ...
    fig.update_layout(
        xaxis2=dict(title_text="Backend", title_font=dict(size=22), tickfont_size=12)
    )
