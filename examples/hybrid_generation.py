...
results = mpm.generate([
    ("Computer Science is about ", ".cache/compressed_models/p2.8b_gsd_133"), 
    ("What is the weather today?", ".cache/compressed_models/p2.8b_gsd_133"),
    ("Alan Turing is ", ".cache/compressed_models/p2.8b_gsd_133"), 
    ("QED is ", ".cache/compressed_models/p2.8b_gsd_133")
])
