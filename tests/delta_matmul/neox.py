...
from transformers.models.gpt_neox.modeling_gpt_neox import GPTNeoXAttention, GPTNeoXConfig, apply_rotary_pos_emb
...
ft_attention.query_key_value.weight = torch.nn.Parameter(base_qkv_weights + delta_qkv_weight)
...
parallel_attention_output, _ = base_attention(hidden_states, attention_masks, position_ids)
