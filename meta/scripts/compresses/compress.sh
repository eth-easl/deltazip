...
python cli/compress.py --base-model google/gemma-2-9b --target-model google/gemma-2-9b-it --outdir .local/compressed_models/ --n-samples 256 --bits 4 --prunen 2 --prunem 4 --lossless none --delta subtract  --shuffle-dataset --fast-tokenizer --perc-damp 0.01 --block-size 128