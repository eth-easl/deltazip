...
in_dir = os.path.join(os.environ.get("YAO_CACHE"), "experiments", "fmzip", "finetuned_raw", "pythia-2.8b-deduped")
out_dir = os.path.join(os.environ.get("YAO_CACHE"), "experiments", "fmzip", "finetuned_compressed", "pythia-2.8b-deduped")
dataset_dir = os.path.join(os.environ.get("YAO_CACHE"), "datasets", "quantitative_natural_instructions", "train")
