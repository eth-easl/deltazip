...
class GPTQ:
    ...
    def fasterquant(self, blocksize=128, percdamp=0.01, group_size=-1, actorder=False):
    ...
    def sparsify(self, frac):
        self.layer.weight.data = hard_threshold(
            self.layer.weight.data, fraction_of_zero=frac
        )
